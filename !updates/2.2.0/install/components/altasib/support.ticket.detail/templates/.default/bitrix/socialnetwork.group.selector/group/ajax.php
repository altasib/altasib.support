...
require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/components/bitrix/socialnetwork.group.selector/functions.php");
...
if ($_REQUEST["mode"] == "search")
{
    ...
    if($APPLICATION->GetUserRight("altasib.support") == 'W')
        $arFilter = array("%NAME" => $_GET["query"]);
