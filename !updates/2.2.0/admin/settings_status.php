...
$adminList->AddHeaders(array(
    array(
        "id" => "NAME",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_STATUS_LIST_NAME"),
        "sort" => "name",
        "default" => true
    ),
...
$data->NavStart();
$adminList->NavText($data->GetNavPrint(Loc::getMessage('ALTASIB_SUPPORT_SETTINGS_STATUS_NAV_TITLE')));
