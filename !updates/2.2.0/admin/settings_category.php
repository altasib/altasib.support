...
$adminList->AddHeaders(array(
    array(
        "id" => "NAME",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_CATEGORY_LIST_NAME"),
        "sort" => "name",
        "default" => true
    ),
    array(
        "id" => "DESCRIPTION",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_CATEGORY_LIST_DESC"),
        "default" => true
    ),
    array(
        "id" => "RESPONSIBLE_USER_ID",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_CATEGORY_LIST_RESPONSIBLE_USER_ID"),
        "default" => true
    ),
    array(
        "id" => "USE_DEFAULT",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_CATEGORY_LIST_DEFAULT"),
        "default" => true
    ),
    array(
        "id" => "NOT_CLOSE",
        "content" => Loc::getMessage("ALTASIB_SUPPORT_SETTINGS_CATEGORY_LIST_NOT_CLOSE"),
        "default" => false
    ),
    array("id" => "ID", "content" => "ID", "sort" => "ID", "default" => true),
));

$data = Support\CategoryTable::getList(array(
    'order' => array($by => $order),
    'filter' => $arFilter,
    'select' => array('*', 'RU_SHORT_NAME' => 'RESPONSIBLE_USER.SHORT_NAME')
));
$data = new CAdminResult($data, $sTableID);
$data->NavStart();
$adminList->NavText($data->GetNavPrint(Loc::getMessage('ALTASIB_SUPPORT_SETTINGS_CATEGORY_NAV_TITLE')));
