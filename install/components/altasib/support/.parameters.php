...
//list
CComponentUtil::__IncludeLang("/local/components/altasib/support.ticket.list/",".parameters.php");
include($_SERVER["DOCUMENT_ROOT"]."/local/components/altasib/support.ticket.list/.parameters.php");
$arComponentParametersList = $arComponentParameters;
unset($arComponentParameters);
//add
CComponentUtil::__IncludeLang("/local/components/altasib/support.ticket.form/",".parameters.php");
include($_SERVER["DOCUMENT_ROOT"]."/local/components/altasib/support.ticket.form/.parameters.php");
$arComponentParametersAdd = $arComponentParameters;
unset($arComponentParameters);

//detail
CComponentUtil::__IncludeLang("/local/components/altasib/support.ticket.detail/",".parameters.php");                
include($_SERVER["DOCUMENT_ROOT"]."/local/components/altasib/support.ticket.detail/.parameters.php");                
