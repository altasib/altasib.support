...
class CategoryTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
        return array(
                ...
                'RESPONSIBLE_USER_ID' => array(
                        ...
                        'validation' => "ALTASIB\Support\CategoryTable::getValidators",
                ),
    ...
    public static function getValidators($value, $primary, $row, $this)
    {
        return array("ALTASIB\Support\CategoryTable::check");
    }
    public static function check($value, $primary, $row, $this)
    {
        if($value == 0)
        {
